...
class Voter implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    #[ORM\OneToOne(mappedBy: 'voter', cascade: ['persist', 'remove'])]
    ...
    public function setDemand(?Demand $demand): static
    {
        ...
        if ($demand === null && $this->demand !== null) {
            $this->demand->setVoter(null);
        }

        // set the owning side of the relation if necessary
        if ($demand !== null && $demand->getVoter() !== $this) {
            $demand->setVoter($this);
        }
